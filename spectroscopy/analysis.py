...
merc_theta_min = unumpy.uarray([48.74, 31.95, 15.89, 0, -15.795, -31.82, -48.74], 0.01)
...
hel_theta_min = unumpy.uarray(
    [-20.43, -19.305, -16.965, -14.49, -14.22, -13.64, -12.92, 12.96, 13.59, 14.22, 14.54, 17.01, 19.35, 20.43],
    0.01)
...
# different wavelength, order number +/-1
hel_delta_min = unumpy.uarray([-48.05, -47.57, -47.21, -47.07, -46.13, -45.54, -45.32], 0.01)
...
hyd_delta_min = unumpy.uarray([-45.09, -46.8, -47.88, -48.56], 0.01)
...
calc_ry_ev = calc_ry / electron_volt

calc_ry_mean = np.mean(noms(calc_ry))
calc_ry_mean_ev = calc_ry_mean / electron_volt
calc_ry_mean_ev_dev = 0.25 * np.sqrt(calc_ry_ev[0].std_dev ** 2
                                     + calc_ry_ev[0].std_dev ** 2
                                     + calc_ry_ev[0].std_dev ** 2
                                     + calc_ry_ev[0].std_dev ** 2)
